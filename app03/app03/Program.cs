...
namespace app03
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Tests
            Animal dog = new Animal("Koda","woof");
            Console.WriteLine("The dog is named {0} and says {1}",
                dog.GetName(), dog.Sound);
            Console.WriteLine("The dog id is {0} and the owner is {1}",
                dog.idNum, dog.Owner);
            Console.WriteLine("The dog lives in {0}",
                dog.GetShelter());
            Console.WriteLine("# of Animals : {0}",
                Animal.NumOfAnimals);
